...
python extract_features.py \
  --input_file=gs://bert-bahasa/concat_hotel_message.txt \
  --output_file=gs://bert-bahasa/concat_hotel_message_output.json \
  --vocab_file=gs://bert-bahasa/bahasa_vocab.txt \
  --bert_config_file=gs://bert-bahasa/bert_config.json \
  --init_checkpoint=gs://bert-bahasa/output_test/model.ckpt \
  --layers=-1 \
  --max_seq_length=128 \
  --batch_size=8
"""
